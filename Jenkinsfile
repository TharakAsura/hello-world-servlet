...
// for display purposes
      ...
      git 'https://github.com/TharakAsura/hello-world-servlet.git'
...
post {
        success {
            mail to:"tharakarameshwara@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
            mail to:"tharakarameshwara@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
